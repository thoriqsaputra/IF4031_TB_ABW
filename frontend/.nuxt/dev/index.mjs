...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Agarthan reports portal for public and personal findings."}],"link":[],"style":[],"script":[],"noscript":[],"title":"Agarthan Reports"};
