...
export const MediaUploader: typeof import("../components/MediaUploader.vue").default
...
export const LazyMediaUploader: LazyComponent<typeof import("../components/MediaUploader.vue").default>
